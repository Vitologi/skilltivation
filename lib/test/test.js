    ...
    Meteor.methods({
        ...
        passMethodsTests: function() {
            ...
            Debugger.group("Checking Sources methods", function(){
                ...
                this.group("Check getSourcesCount method", function(){

                    _this.setUserId(null);
                    this.assert(!Meteor.call("getSourcesCount"), "Can`t get source count method without privileges");
                    _this.setUserId(storedUserId);

                    testSourcesCount = Meteor.call("getSourcesCount");

                    this.assert(Sources.find({"userId":storedUserId}).count() === testSourcesCount, "Get sources count correctly");
                });
            ...
            if(this.userId === "ZWsGhWFYxqnAiRFP4")_this.setUserId(null);
        }
